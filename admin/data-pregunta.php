              ...
              <table id="example2" class="table table-bordered table-hover dataTable dtr-inline" aria-describedby="example2_info">
                <thead>
                  <tr>
                    ...
                    <th class="sorting" tabindex="0" aria-controls="example2" rowspan="1" colspan="1">Pregunta</th>
                    <th class="sorting" tabindex="0" aria-controls="example2" rowspan="1" colspan="1">Respuesta Correcta</th>
                    <th class="sorting" tabindex="0" aria-controls="example2" rowspan="1" colspan="1">Imagen</th>
                    <th class="sorting" tabindex="0" aria-controls="example2" rowspan="1" colspan="1">Acciones</th>
                  </tr>
                </thead>
                <tbody id="tabla-pregunta">
                  <?php
                  try {
                    $sql = "SELECT id, pregunta, respuesta_correcta, img from pregunta WHERE id_nivel = '$id'";
                  ...
                  ?>
                    ...
                    <td><?php echo $usuario['id'] ?></td>
                      ...
                      <td><?php echo $usuario['respuesta_correcta'] ?></td>
                      <td><?php echo $usuario['img'] ?></td>
                      <td>
                        <!-- envio por GET -->
                        <a href="actualizar-pregunta.php?id=<?php echo $usuario['id'] ?>" class="btn btn-light">Actualizar</a>
                        <button class="btn btn-danger" id="eliminar" data-id="<?php echo $usuario['id'] ?>" data-tipo="pregunta" id="eliminar" value="<?php echo $usuario['id'] ?>">Eliminar</button>
                    </tr>
                  <?php
                  }
                  ?>
