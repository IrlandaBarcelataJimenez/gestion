              ...
              <div class="col d-flex flex-column h-sm-100">
                <main class="row overflow-auto">
                  <div class="col pt-4">
                    ...
                    <p class="lead">Crear una pregunta nueva con sus respuestas.</p>
                    <hr />

                    <form id="crear-pregunta" action="modelo-examen.php" method="post">

                      <fieldset>
                        <div class="fila">
                          <label for="preg1" class="numero-pregunta">Pregunta</label>
                          <input class="pregunta" type="text" name="preg" id="preg">

                          <!-- Seleccionar opcion correcta -->
                          <label for="respuesta_correcta" class="respuesta_correcta">Opción correcta</label>

                          <select name="respuesta_correcta" id="respuesta_correcta">
                        ...
                        <div class="fila">
                          ...
                          <div class="input-opciones">
                            <div class="opcion">
                              <label>0</label>
                              <input type="text" name="preg_opcion_a">
                            </div>

                            <div class="opcion">
                              <label>1</label>
                              <input type="text" name="preg_opcion_b">
                            </div>

                            <div class="opcion">
                              <label>2</label>
                              <input type="text" name="preg_opcion_c">
                            </div>

                            <div class="opcion">
                              <label>3</label>
                              <input type="text" name="preg_opcion_d">
                            </div>
                          </div>
                        </div>
                      </fieldset>
