                ...
                <tbody id="cuerpo-tabla">
                  ...
                  ?>
                    <tr>
                      ...
                      <td>
                        <!-- envio por GET -->
                        <a href="data-pregunta.php?id=<?php echo $usuario['id'] ?>" class="btn btn-light">Ver preguntas</a>
                        <a href="data-respuesta.php?id=<?php echo $usuario['id'] ?>" class="btn btn-light">Ver respuestas</a>
                        <a href="actualizar-nivel.php?id=<?php echo $usuario['id'] ?>" class="btn btn-light">Actualizar</a>
                        <button class="btn btn-danger" id="eliminar" data-id="<?php echo $usuario['id'] ?>" data-tipo="nivel" id="eliminar" value="<?php echo $usuario['id'] ?>">Eliminar</button>
                      </td>
                    </tr>
                  <?php
                  }
