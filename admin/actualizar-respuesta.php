                            ...
                            <div class="col d-flex flex-column h-sm-100">
                                <main class="row overflow-auto">
                                    <div class="col pt-4">
                                        ...
                                        <p class="lead">Edita una respuesta del test.</p>
                                        <hr />
                                        ...
                                        <div class="col-sm-8">
                                            ...
                                            <form id="editar-registro" action="modelo-respuesta.php" method="post">

                                                <div class="mb-3">
                                                    <label for="respuesta" class="form-label">Respuesta:</label>
                                                    <input type="text" class="form-control" id="respuesta" name="respuesta" value="<?php echo $usuario['respuesta'] ?>">
                                                </div>

                                                <div class="mb-3">
                                                    <label for="inciso" class="form-label">Inciso:</label>
                                                    <input type="text" class="form-control" id="inciso" name="inciso" value="<?php echo $usuario['inciso'] ?>">
                                                </div>
