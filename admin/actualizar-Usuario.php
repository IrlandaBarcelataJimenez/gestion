                            ...
                            <div class="col d-flex flex-column h-sm-100">
                                <main class="row overflow-auto">
                                    <div class="col pt-4">
                                        ...
                                        <p class="lead">Edita un usuario registrado.</p>
                                        <hr />
                                        ...
                                        <div class="col-sm-8">
                                            ...
                                            try {
                                                $sql = "SELECT idUsuario, nombre, apPat, apMat FROM usuario WHERE idUsuario = $id LIMIT 1";
                                            ...
                                            <form id="editar-registro" action="modelo-Admin.php" method="post">
                                                ...
                                                <div class="mb-3">
                                                    ...
                                                    <input type="text" class="form-control" id="apPat" name="apPat" value="<?php echo $usuario['apPat'] ?>">
                                                </div>

                                                <div class="mb-3">
                                                    <label for="apMat" class="form-label">Apellido Materno:</label>
                                                    <input type="text" class="form-control" id="apMat" name="apMat" value="<?php echo $usuario['apMat'] ?>">
                                                </div>

                                                <div class="mb-3">
                                                    <button type="submit" class="btn btn-primary" id="actualizar-registro">Actualizar</button>
                                                    <input type="hidden" name="registro" value="actualizar">
                                                    <input type="hidden" name="id_registro" value="<?php echo $usuario['idUsuario'] ?>">
                                                </div>
