...
<body>
    ...
    <nav class="navbar navbar-expand-md navbar-dark fixed-top bg-dark">
      <div class="container-fluid">
        ...
        <div class="collapse navbar-collapse navletter" id="navbarCollapse">
          ...
          <div class="main">
            <a href="login.php" class="user"><i class="ri-user-fill"></i>Iniciar Sesión</a>
            <!-- <div class="bx bx-menu" id="menu-icon"></div> -->
          </div>
          <div class="main">
            <a href="registro.php" class="user"><i class="ri-user-add-fill"></i>Registrarse</a>
            <!-- <div class="bx bx-menu" id="menu-icon"></div> -->
        </div>
      </div>
    </nav>
  ...
  ================================================== -->
    ...
    <footer class="container">
      ...
      <div style="text-align: center;" class="col"><?php echo date('Y'); ?> &copy; Todos los derechos reservados | Pensamiento Computacional</div>
    </footer>
  </main>
