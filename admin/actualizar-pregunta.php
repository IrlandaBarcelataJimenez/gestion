                            ...
                            <div class="col d-flex flex-column h-sm-100">
                                <main class="row overflow-auto">
                                    <div class="col pt-4">
                                        ...
                                        <p class="lead">Edita una pregunta del test.</p>
                                        <hr />
                                        ...
                                        <div class="col-sm-8">
                                            ...
                                            <form id="actualizar-registro" action="modelo-pregunta.php" method="post">

                                                <div class="mb-3">
                                                    <label for="pregunta" class="form-label">Pregunta:</label>
                                                    <input type="text" class="form-control" id="pregunta" name="pregunta" value="<?php echo $usuario['pregunta'] ?>">
                                                </div>

                                                <div class="mb-3">
                                                    <label for="respuesta-correcta" class="form-label">Respuesta Correcta:</label>
                                                    <input type="text" class="form-control" id="respuesta-correcta" name="respuesta-correcta" value="<?php echo $usuario['respuesta_correcta'] ?>">
                                                </div>

                                                <div class="mb-3">
                                                    <label for="imagen" class="form-label">Imagen:</label>
                                                    <input type="text" class="form-control" id="imagen" name="imagen" value="<?php echo $usuario['img'] ?>">
                                                </div>
